...
MODULES.legalCompliance = {
  ...
  plenary:{
    ...
    quiz:[
      ...
      {q:'Which of the eight DPA 1998 principles requires organisations to implement appropriate technical and organisational security measures to protect personal data?',options:['Principle 1 — data must be processed fairly and lawfully','Principle 4 — data must be accurate and kept up to date','Principle 7 — appropriate security measures must be in place to protect against unauthorised access or loss'],correct:2},
...
MODULES.malwareAnalysis = {
  ...
  plenary:{
    ...
    quiz:[
      ...
      {q:'What is the difference between signature-based and behavioural detection in endpoint security?',options:['Signature-based monitors user behaviour patterns; behavioural detection uses a database of known malware file hashes','Signature-based matches patterns of known malware and misses new threats; behavioural detection identifies suspicious actions and can catch zero-day malware','Signature-based detection runs on servers only; behavioural detection runs on workstations only'],correct:1}
    ]
  }
};
